...
function(vmtk_build_library)
  ...
  install(TARGETS ${lib_name}
    EXPORT VMTK-Targets
    LIBRARY DESTINATION ${VMTK_INSTALL_LIB_DIR} COMPONENT RuntimeLibraries
    ARCHIVE DESTINATION ${VMTK_INSTALL_LIB_DIR} COMPONENT Development
    RUNTIME DESTINATION ${VMTK_INSTALL_BIN_DIR} COMPONENT RuntimeExecutables
  )

  file(GLOB files "${CMAKE_CURRENT_SOURCE_DIR}/*.h")
  install(FILES ${files}
    DESTINATION ${VMTK_INSTALL_INCLUDE_DIR}
  ...
  if (VTK_WRAP_PYTHON)
    ...
    if(NOT DEFINED VTK_VMTK_WRAPPED_MODULE_INSTALL_LIB_DIR)
      set(VTK_VMTK_WRAPPED_MODULE_INSTALL_LIB_DIR ${VMTK_MODULE_INSTALL_LIB_DIR})
    endif()
    ...
    vtkMacroKitPythonWrap(
      ...
      KIT_INSTALL_BIN_DIR ${VMTK_INSTALL_BIN_DIR}
      KIT_INSTALL_LIB_DIR ${VMTK_INSTALL_LIB_DIR}
      KIT_MODULE_INSTALL_LIB_DIR ${VMTK_MODULE_INSTALL_LIB_DIR}
      )
  endif ()
